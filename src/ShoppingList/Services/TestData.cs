...
namespace ShoppingList.Services {
    public class TestData {
        ...
        public void InsertTestData(IRepository target) {
            ...
            var sl1 = _shoppingListFactory.Create(stores[0], DateTime.Today + TimeSpan.FromDays(2), items.TakeRandom(5, 15).ToArray(), new Guid("{E753B7F9-152F-4C2C-ACF4-C6D12F3460C3}"));
